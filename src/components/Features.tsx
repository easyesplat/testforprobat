...
// Variant component (with "Learn More" buttons)
const FeaturesVariant: React.FC = () => {
  ...
  const handleFeatureClick = (featureTitle: string) => {
    // Track feature_card_click event with feature title
    console.log('feature_card_click', { feature: featureTitle })
          ...
          {features.map((feature, index) => (
            <div key={index} className="feature-card">
              ...
              <button 
                ...
                style={{ marginTop: '1rem', fontSize: '14px', padding: '8px 16px' }}
              >
                Learn More
              </button>
            </div>
