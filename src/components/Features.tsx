...
// Control component (original centered layout)
      ...
      <div className="container">
        ...
        <div className="features-grid">
          {features.map((feature, index) => (
            <div key={index} className="feature-card control">
...
// Variant component (left-aligned layout)
  ...
  return (
    <section className="features" id="features">
      <div className="container">
        ...
        <div className="features-grid">
          {features.map((feature, index) => (
            <div key={index} className="feature-card variant">
              <div className="feature-icon">
                {feature.icon}
              </div>
              <h3 className="feature-title">{feature.title}</h3>
...
// Wrapper component with the original export name
