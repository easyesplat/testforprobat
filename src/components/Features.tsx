...
// Variant component (V1 with Learn More buttons)
const FeaturesVariant: React.FC = () => {
  ...
  const handleLearnMoreClick = (featureTitle: string) => {
    // Click tracking for feature CTA buttons
        ...
        <div className="features-grid">
          {features.map((feature, index) => (
            <div key={index} className="feature-card">
              ...
              <p className="feature-description">{feature.description}</p>
              <button 
                className="btn btn-primary feature-cta"
                onClick={() => handleLearnMoreClick(feature.title)}
              >
                Learn More
              </button>
            </div>
