...
// Control component (original version without Learn More button)
...
// Variant component (version with Learn More button)
        ...
        <div className="features-grid">
          {features.map((feature, index) => (
            <div key={index} className="feature-card">
              ...
              <h3 className="feature-title">{feature.title}</h3>
              <p className="feature-description">{feature.description}</p>
              <a href="#" className="btn btn-small feature-cta">
                Learn More →
              </a>
            </div>
          ))}
...
const Features: React.FC = () => {
  return (
    <Experiment
      id="exp_Features_20260316_4f8e9a1c"
